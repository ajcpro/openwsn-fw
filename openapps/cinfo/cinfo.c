...
owerror_t cinfo_receive(
   ...
   switch (coap_header->Code) {
      case COAP_CODE_REQ_GET:
         ...
         msg->payload[sizeof(infoStackName)-1+5-6] = '0'+OPENWSN_VERSION_MAJOR;
         msg->payload[sizeof(infoStackName)-1+5-5] = '.';
         msg->payload[sizeof(infoStackName)-1+5-4] = '0'+OPENWSN_VERSION_MINOR / 10;
         msg->payload[sizeof(infoStackName)-1+5-3] = '0'+OPENWSN_VERSION_MINOR % 10;
